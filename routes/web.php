...
use App\Http\Controllers\StockRapportController;
...
Route::group(['middleware'=>['auth']],function (){
    ...
    Route::match(['get', 'post'], '/annual-category-report', [StockRapportController::class, 'generateAnnualCategoryReport'])
    ->name('annual-category-report');
    ...
    Route::match(['get', 'post'], '/generate-service-sales-report', [StockRapportController::class, 'generateServiceSalesReport'])
    ->name('generate-service-sales-report');
    ...
    Route::get('/stock-report', [StockRapportController::class, 'generateStockReport'])->name('stock-report');
    Route::get('/annual', [StockRapportController::class, 'generateAnnualStockReport'])->name('annual');
    Route::post('/annual', [StockRapportController::class, 'generateAnnualStockReport'])->name('annual');
    ...
    Route::get('/sales-purchases-chart', [StockRapportController::class, 'salesPurchasesChart'])->name('sales-purchases-chart');
