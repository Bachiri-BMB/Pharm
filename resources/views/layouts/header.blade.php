    ...
    <div class="container">
        <div class="m-header">
            {{-- <a class="mobile-menu" id="mobile-collapse" href="#!"><span></span></a> --}}
			    ...
			    <img class="logo" width="200" height="70" src="@if(!empty(AppSettings::get('logo'))) {{asset('storage/'.AppSettings::get('logo'))}} @else{{asset('img/p.jpg')}} @endif" alt="Logo">
                ...
                <li>
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{ asset('/img/Police_Algérie.png') }}" class="img-radius" alt="User-Profile-Image">
